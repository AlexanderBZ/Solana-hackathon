  ...
  return (
    ...
    candyMachine.state && (
      <div>
        ...
        <Button className="mnt-button">
          {candyMachine.state.itemsRedeemed ===
          candyMachine.state.itemsAvailable ? (
            <p>Sold Out 🙊</p>
          ) : (
            <div onClick={mintToken}>
              <p>Mint NFT Membership</p>
            </div>
          )}
        </Button>
        <p className="explanation">
          {`There are currently ${candyMachine.state.itemsRedeemed} / ${candyMachine.state.itemsAvailable} memberships minted`}
          . Make sure to check out WTF is Web3's private podcast here -{" "}
          <a href="https://open.kickback.fm/podcast/wwCqLPD5eZ7Tan1ai1YP5Q">
            Private Podcast Page
          </a>{" "}
